...
import 'package:footprints/widgets/app_bar/appbar_subtitle_two.dart';
                ...
                child: Column(children: [
                  ...
                  Padding(
                      ...
                      child: _buildEmailRow(context,
                          emailLabel: "Username", emailText: "Rosalia")),
                  SizedBox(height: 29.v),
                  Padding(
                      padding: EdgeInsets.symmetric(horizontal: 16.h),
                      child: _buildEmailRow(context,
                          emailLabel: "Email", emailText: "xyz@gmail.com")),
                  SizedBox(height: 28.v),
                  Padding(
                      padding: EdgeInsets.symmetric(horizontal: 16.h),
                      child: _buildEmailRow(context,
                          emailLabel: "Phone", emailText: "+12 3456 789 000")),
                  ...
                  Padding(
                      padding: EdgeInsets.symmetric(horizontal: 16.h),
                      child: _buildEmailRow(context,
                          emailLabel: "Gender", emailText: "Female")),
                  SizedBox(height: 29.v),
                  Padding(
                      padding: EdgeInsets.symmetric(horizontal: 16.h),
                      child: _buildEmailRow(context,
                          emailLabel: "Date of birth",
                          emailText: "21/08/1992")),
                  SizedBox(height: 5.v)
                ]))));
  }
